...
/*
СВЕРШИЛОСЬ!!!!1 
В компании Qualium Systems объявляется набор на СТАЖИРОВКУ!!!

Что она будет включать - 1 месяц работы над НЕКОММЕРЧЕСКИМ проектом с последующим переходом в интернатуру, под руководством опытного ментора, для выполнения заданий на КОММЕРЧЕСКОМ проекте.

MUST HAVE: базовые знания JavaScript, HTML, CSS, баз данных и уровень английского Pre-Intermediate.

Почему такая картинка?!
Потому что в качестве тестового задания необходимо сделать простейшую ИГРУ. 
Более подробно далее:
Используя приложенный шаблон (он в архиве jstesttask.zip под картинкой), написать мини игру. 
...
P.S. Можете писать без использования canvas, если есть желание. 

Свои выполненные тестовые задания, а также РЕЗЮМЕ присылайте на job@qualium-systems.com с пометкой "СТАЖИРОВКА" 
Удачи!!!
